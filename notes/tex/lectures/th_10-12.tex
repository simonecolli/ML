...
% NUOVO: Paragrafo introduttivo per distinguere teoria e pratica.
...
% NUOVO: Definizione che parte dalla teoria e arriva alla pratica.
...
% NUOVO: Spiegazione riscritta per seguire il flusso logico pratico.
...
% NUOVO: Contesto per i teoremi seguenti.
...
% NOTA: La dimostrazione originale è stata lasciata intatta, interpretando le
variabili in senso teorico.
% La sua applicazione pratica al dataset è una conseguenza diretta.
...
\begin{enumerate}
    % NUOVO: Notazione e terminologia aggiornate
...
\paragraph{Relazione con la PCA.}
